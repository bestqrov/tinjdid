...
export class FinanceController {
  ...
  @Post('charges')
  @Roles('ADMIN','STAFF')
  createCharge(@Query('companyId') companyId: string, @Body() body: import('../charges/dto/create-charge.dto').CreateChargeDto) {
  ...
  async stats(@Query('companyId') companyId: string, @Query('start') start?: string, @Query('end') end?: string) {
